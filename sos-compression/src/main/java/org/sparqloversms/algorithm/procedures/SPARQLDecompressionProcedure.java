...
public class SPARQLDecompressionProcedure implements DecompressionProcedure {

    private Decoder decoder;
    private Deserializer deserializer;
    private Serializer serializer;

    public SPARQLDecompressionProcedure(Decoder decoder, Deserializer deserializer, Serializer serializer) {
